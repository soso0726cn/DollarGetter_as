...
import com.adis.tools.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.adis.tools.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.adis.tools.db.table.Id>();

    /* package */
    static synchronized com.adis.tools.db.table.Id getId(Class<?> entityType) {
        ...
        com.adis.tools.db.table.Id id = new com.adis.tools.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.adis.tools.db.table.Id id = getId(entityType);
