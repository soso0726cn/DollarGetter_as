...
package com.adis.tools.db.table;

import android.text.TextUtils;
import com.adis.tools.db.annotation.*;
import com.adis.tools.db.annotation.Column;
import com.adis.tools.db.annotation.Finder;
import com.adis.tools.db.annotation.Foreign;
import com.adis.tools.db.annotation.Id;
import com.adis.tools.db.converter.ColumnConverter;
import com.adis.tools.db.converter.ColumnConverterFactory;
import com.adis.tools.db.sqlite.FinderLazyLoader;
import com.adis.tools.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.adis.tools.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.adis.tools.db.table.Finder finderColumn) {
