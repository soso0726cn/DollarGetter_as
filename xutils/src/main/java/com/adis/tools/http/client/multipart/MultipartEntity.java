...
package com.adis.tools.http.client.multipart;

import com.adis.tools.http.callback.RequestCallBackHandler;
import com.adis.tools.http.client.entity.UploadEntity;
