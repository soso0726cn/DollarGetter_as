...
#include "log.h"
#include "constant.h"
#include "com_slk_daemon_nativ_NativeDaemonAPI20.h"
...
JNIEXPORT void JNICALL Java_com_slk_daemon_nativ_NativeDaemonAPI20_doDaemon(JNIEnv *env, jobject jobj, jstring pkgName, jstring svcName, jstring daemonPath){
