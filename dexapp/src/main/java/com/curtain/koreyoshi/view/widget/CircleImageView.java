...
public class CircleImageView extends ImageView {
    ...
    public void setCornerRadius(float rectCornerRadius){
        this.mRectCornerRadius = rectCornerRadius;
//        invalidate();
        setup();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mType == TYPE_CIRCLE) {
            ...
            canvas.drawRoundRect(mDrawableRect, mRectCornerRadius, mRectCornerRadius,mBitmapPaint);
        }
    }
